...
@section('content')
    ...
    <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form method="post" action="{{url('/@admin@/manageAdmin/updateAdminAction')}}" enctype="multipart/form-data" role="form">
            {{csrf_field()}}
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="address" value="{{$admin->address}}" class="form-control" placeholder="Enter Address">
